...
#include "basketfieldd.h"
#include "basketfrenzysub.h"
...
void P_Map16x16_configureBG2_Sub()
{
    ...
    swiCopy(basketfrenzysubPal, BG_PALETTE_SUB, basketfrenzysubPalLen);
    swiCopy(basketfrenzysubBitmap, BG_GFX_SUB, basketfrenzysubBitmapLen);
}
...
void P_Map16x16_configureBG3()
{
	...
	swiCopy(basketfielddTiles, BG_TILE_RAM(0), basketfielddTilesLen);
	swiCopy(basketfielddMap, BG_MAP_RAM(26), basketfielddMapLen);
	swiCopy(basketfielddPal, BG_PALETTE, basketfielddPalLen);
